  ...
  ***************************************************************************** */
  ...
  methodsToPatch.forEach(function (method) {
      ...
      def(arrayMethods, method, function mutator() {
          ...
          {
              ob.dep.notify({
                  type: "array mutation" /* ARRAY_MUTATION */,
                  target: this,
                  key: method
              });
          }
  ...
  function shallowReactive(target) {
      ...
      def(target, "__v_isShallow" /* IS_SHALLOW */, true);
      return target;
  }
  ...
  function createRef(rawValue, shallow) {
      ...
      def(ref, "__v_isShallow" /* IS_SHALLOW */, true);
  ...
  function createReadonly(target, shallow) {
      ...
      def(proxy, "__v_isReadonly" /* IS_READONLY */, true);
      def(proxy, "__v_raw" /* RAW */, target);
      if (isRef(target)) {
          def(proxy, RefFlag, true);
      }
      if (shallow || isShallow(target)) {
          def(proxy, "__v_isShallow" /* IS_SHALLOW */, true);
      }
  ...
  function computed(getterOrOptions, debugOptions) {
      ...
      def(ref, RefFlag, true);
      def(ref, "__v_isReadonly" /* IS_READONLY */, onlyGetter);
      return ref;
  }
